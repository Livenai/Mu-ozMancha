...
public:
    ...
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &GotoPointPrx::_iceI_go, nodo, x, y, alpha, context);
    }
    ...
    turnAsync(float speed,
              ...
              const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &GotoPointPrx::_iceI_turn, speed, context);
    }
    ...
    stopAsync(::std::function<void()> response,
              ...
              const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &GotoPointPrx::_iceI_stop, context);
    }
    ...
    atTargetAsync(::std::function<void(bool)> response,
                  ...
                  const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<bool>(response, ex, sent, this, &GotoPointPrx::_iceI_atTarget, context);
    }
