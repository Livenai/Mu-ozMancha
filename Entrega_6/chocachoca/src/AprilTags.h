...
public:
    ...
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &AprilTagsPrx::_iceI_newAprilTag, tags, context);
    }
    ...
    newAprilTagAndPoseAsync(const tagsList& tags, const ::RoboCompGenericBase::TBaseState& bState, const ::RoboCompJointMotor::MotorStateMap& hState,
                            ...
                            const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &AprilTagsPrx::_iceI_newAprilTagAndPose, tags, bState, hState, context);
    }
