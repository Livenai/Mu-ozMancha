...
RoboCompCommonHead::CommonHead::_iceD_getHeadParams(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    THeadParams ret = this->getHeadParams(current);
...
/// \cond INTERNAL
void
RoboCompCommonHead::CommonHeadPrx::_iceI_getHeadParams(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<THeadParams>>& outAsync, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
RoboCompCommonHead::CommonHeadPrx::_iceI_getHeadState(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<THeadState>>& outAsync, const ::Ice::Context& context)
{
...
{
    return CommonHead::ice_staticId();
}
...
/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::RoboCompCommonHead::upCast(CommonHead* p) { return p; }

void
::IceProxy::RoboCompCommonHead::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< CommonHead>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
void IceProxy::RoboCompCommonHead::CommonHead::_iceI_end_getHeadState(::RoboCompCommonHead::THeadState& iceP_hState, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_RoboCompCommonHead_CommonHead_getHeadState_name);
    if(!result->_waitForResponse())
    {
...
/// \cond INTERNAL
::Ice::Object* RoboCompCommonHead::upCast(CommonHead* p) { return p; }
...
RoboCompCommonHead::CommonHead::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ...
    ::Ice::StreamWriter< CommonHead, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    ::Ice::StreamReader< CommonHead, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
{
    handle = CommonHeadPtr::dynamicCast(v);
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(CommonHead::ice_staticId(), v);
    }
}
/// \endcond
